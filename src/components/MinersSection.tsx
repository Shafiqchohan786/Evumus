    ...
    <section className="relative py-24 md:py-32 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4">
        ...
        <div className="text-center mb-20 max-w-3xl mx-auto">
          ...
          >
            <span className="text-gradient-hero bg-clip-text text-transparent">Your Gateway</span>
            <br />
          ...
          >
            The only way to collect coins — <span className="text-primary font-semibold">60% of supply locked in mining</span>. Evumus miners are
            more than just distribution mechanisms. Your <span className="text-foreground font-semibold">exclusive access to predictions, AI
            builders, and automated workflows</span> — customize, upgrade, and unlock through one core asset.
          </motion.p>
        </div>
